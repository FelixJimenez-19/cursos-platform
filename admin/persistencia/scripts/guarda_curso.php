...
if(isset($_POST['id'])){
  ...
  if($id == 0){
    //GUARDAR / INICIO
    $_curso -> guardar($nombre, $fecha_inicio, $fecha_fin, $numero_cupos, $link_whatsapp, $id_modelo_curso);
    ...
    //EDITAR / INICIO
    $_curso -> editar($nombre, $fecha_inicio, $fecha_fin, $numero_cupos, $link_whatsapp, $id_modelo_curso, $id);
    if($foto['tmp_name'] != "" or $foto['tmp_name'] != null){
      $desde = $foto['tmp_name'];
      $hasta = '../../presentacion/fotos/curso/'.$id.'.png';
      copy($desde,$hasta);
