...
?>
    ...
    <head>
        ...
        <title>Certificado - <?= strtoupper($r['certificado_nombre_participante']) ?></title>
    ...
    <body>
        ...
        <table style="color:#4F5152;" border="0">
            <tr>
                <td>
                    <img src="../../../img_db/sellos/firma_rectora.png" width="auto" height="75px">
                    <br>____________________________ <br>
                    <b><?= ucwords(strtolower($r['certificado_rector_institucion'])) ?></b><br>Rector(a)
                </td>
                <td rowspan="2">
                    <img src="../../../img_db/sellos/sello_institucion.png" width="auto" height="130px">
                </td>
                <td rowspan="2">
                    <img src="../../../img_db/sellos/sello_educacion.png" width="auto" height="130px">
                </td>
                <td>
                    <img src="../../../admin/presentacion/fotos/profesor/firma/<?= $r_c['profesor_firma'] ?>" width="auto" height="75px">
                    <br>____________________________ <br>
